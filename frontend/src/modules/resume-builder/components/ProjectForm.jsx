...
const ProjectForm = ({ data: legacyData = [], onChange, sectionId }) => {
  ...
  useEffect(() => {
    console.log(
      "ProjectForm useEffect fired - activeItemId:",
      activeItemId,
      "items:",
      data.map((p) => p.id),
    );
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="border-b border-slate-100 pb-6">
        ...
        <p className="text-slate-500 mt-1">
          Showcase your work, personal projects, or contributions.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <SortableList
          items={data.map((item) => {
            ...
            const stableId =
              item.id || item._id || item.tempId || `temp-${Math.random()}`;
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${expandedId === project.id ? "bg-blue-600 text-white" : "bg-slate-100 text-slate-500"}`}
                    >
                      {index + 1}
                    </div>
                    <div>
                  ...
                  <div className="p-6 bg-white animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="mb-5">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <button
                          onClick={() =>
                            enhanceDescription(index, project.description)
                          }
