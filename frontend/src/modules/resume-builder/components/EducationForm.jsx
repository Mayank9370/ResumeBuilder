              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${expandedId === education.id ? "bg-blue-600 text-white" : "bg-slate-100 text-slate-500"}`}
                    >
                      {index + 1}
                    </div>
                    <div>
                  ...
                  <div className="p-6 bg-white animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="space-y-2 mt-4">
                      <div className="flex justify-between items-center">
                        ...
                        <button
                          onClick={() =>
                            enhanceDescription(index, education.description)
                          }
